 <section class="course-details">
      ...
      <section class="eventsBanner" style="background: url(<?php echo base_url('uploads/events/banner_images/'.$get_single_events[0]['banner_images1']);?>) no-repeat;">
            <div class="container">
                  <div class="row">
                      <div class="col-md-8">
                          <div class="newsText">
                             <a href="<?php echo base_url('events/').$get_single_events[0]['slug'];?>">
                              <p><span><?=date('d', strtotime($get_single_events[0]['event_date']))?> / </span><?=date('M Y', strtotime($get_single_events[0]['event_date']))?></p>
                              <h3><?=$get_single_events[0]['title']?></h3>
                              </a>
                          </div>
                      </div>
                      <div class="col-md-4">
                          <div class="monthBox">
                              ...
                              <?php foreach($get_two_events as $twoVal){?>
                              <div class="dateDetails">
                                    <a href="<?php echo base_url('events/').$twoVal['slug'];?>">
      ...
      <section class="newsDetils1">
          <div class="container showEventsAanNewsClass">
              <div class="row">
                  <?php foreach($get_remaining_events as $remainingVal){?>
                  <div class="col-md-4">
                     <a href="<?php echo base_url('events/').$remainingVal['slug'];?>" class="dateDetails">
                        ...
                        <div class="insideImage">
                            <img src="<?php echo base_url('uploads/events/'.$remainingVal['image']);?>" alt="events1">
              ...
              <?php if(count($get_remaining_events) >9){ ?>
      ...
      <script type="text/javascript">
          ...
          function showData(str)
          {
            var month = $('#month').val();
            var year = $('#year').val();
            $.post(site_url+"Events/showEvents",
            {   type: 1,
                month: month,
                year: year
            },
