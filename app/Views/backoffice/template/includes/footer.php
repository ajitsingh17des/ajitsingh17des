				...
				<div class="m-container m-container--fluid m-container--full-height m-page__container">
					<div class="m-stack m-stack--flex-tablet-and-mobile m-stack--ver m-stack--desktop">
						<div class="m-stack__item m-stack__item--left m-stack__item--middle m-stack__item--last">
							...
							<p>©Reva -All Rights reserved Designed and developed by <a href="https://www.stercodigitex.com/" target="_blank">Sterco Digitex</a></p>
							</span>
						</div>
...
<!--begin::Global Theme Bundle -->
		<script src="<?php echo base_url();?>custum_js/custum.js" type="text/javascript"></script>
		<script src="<?php echo base_url();?>assets/vendors/base/vendors.bundle.js" type="text/javascript"></script>
		<script src="<?php echo base_url();?>assets/demo/default/base/scripts.bundle.js" type="text/javascript"></script>	
		<!-- AUTO COMPLETE JS START HERE -->		
		 <!-- <script src="<?php echo base_url();?>custum_js/auto_complete/jquery-ui.js"></script>	 -->	 
		 <!-- AUTO COMPLETE JS START HERE -->
		...
		<script src="<?php echo base_url();?>assets/demo/default/custom/crud/forms/widgets/select2.js" type="text/javascript"></script>
		...
		tinymce.init({
		    selector: ".editor",width: '100%', height: '200',
		     plugins: [
		    ...
		    toolbar1: "undo redo | bold italic underline | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent ",
				...
				valid_children: "+a[div|h1|h2|h3|h4|h5|h6|p|#text]",
		          external_filemanager_path: "<?php echo base_url();?>tinymce/filemanager/",
		          filemanager_title: "Responsive Filemanager",
		           external_plugins: { "filemanager" : "<?php echo base_url(); ?>tinymce/filemanager/plugin.min.js"}
		});
