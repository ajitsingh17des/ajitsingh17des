					...
					<div class="m-portlet__head-tools">
						<ul class="m-portlet__nav">
							<li class="m-portlet__nav-item">
								...
								<a href="<?php echo base_url('backoffice/testimonials/add') ?>" class="btn m-btn--pill btn-outline-success m-btn m-btn--custom m-btn--icon ">
					...
					<table class="m-datatable" id="html_table" width="100%">
						...
						<tbody>
							<?php
								...
								$sno=1; 
									foreach($testimonial['testimonial'] as  $value){
							...
							?>
								...
								<td><center><?php echo $value['type'];?></center></td>
								<td><center><?php echo $value['designation'];?></center></td>
								<td><center>
									<?php if(!empty($value['image'])){
										$image = 'uploads/testimonial/'.$value['image'];
									}else{
										$image = 'uploads/none.png';
									} ?>
									<a href="<?php echo base_url($image);?>" target="_blank"><img src="<?php echo base_url($image);?>" style="height: 50px;"></a>
								</center></td>
								...
								<td>
									<center>
											<div class="m-btn-group m-btn-group--pill btn-group" role="group" aria-label="First group">
												<a href="<?php echo base_url('backoffice/testimonials/edit/'.$value['id'])?>">
													<span class="btn m-btn--square  m-btn m-btn--gradient-from-info m-btn--gradient-to-accent"><i class="fa fa-pencil-alt"></i></span>
												</a>
												<a onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo base_url('backoffice/testimonials/delete/'.$value['id']) ?>">
												...
												<a onclick="return confirm('Do you sure want to deactive this record.');" href="<?php echo base_url(); ?>backoffice/testimonials/deactive/<?php echo $value['id']; ?>" title="Deactive" > 
												...
												<a>	
												<?php } else { ?>
												<a onclick="return confirm('Do you sure want to active this record.');" href="<?php echo base_url(); ?>backoffice/testimonials/active/<?php echo $value['id']; ?>" title="Active" >
