...
<html lang="en">
	...
	<body class="m--skin- m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--fixed m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default">
		...
		<div class="m-grid m-grid--hor m-grid--root m-page">
			<div class="m-grid__item m-grid__item--fluid m-grid m-grid--hor m-login m-login--signin m-login--2 m-login-2--skin-2" id="m_login" style="background-image: url(<?php echo base_url();?>assets/app/media/img//bg/bg-3.jpg);">
				<div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
					<div class="m-login__container">
						<div class="m-login__logo">
							<a href="#">
								<img class="xebia_logo" src="<?php echo base_url();?>assets/app/media/img/logos/logo.svg">
							</a>
						</div>
						<div class="m-login__signin">
							...
							<form class="m-login__form m-form" action="<?php echo base_url() ?>backoffice/login" method="post">
							    <p class="form-control-feedback errorr"><?php echo $login_error ?></p>
								<div class="form-group m-form__group">
									<input class="form-control m-input" type="text" placeholder="Email" name="emailid" value="<?php echo $formData['emailid'] ?>" autocomplete="off">
								    <p class="form-control-feedback errorr">
                                		<?php if($validation->getError('emailid') && isset($_POST['signin']))
                                		{
                                			echo $validation->getError('emailid');
                                		}?>
                            		</p>
								</div>
								<div class="form-group m-form__group">
									<input class="form-control m-input m-login__form-input--last" type="password" placeholder="Password" name="password" value="<?php echo $formData['password'] ?>">
								
								    <p class="form-control-feedback errorr">
                                		<?php if($validation->getError('password') && isset($_POST['signin']))
                                		{
								...
								<div class="m-login__form-action">
									<button id="m_login_signin_submit" type="submit" name="signin" class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air m-login__btn m-login__btn--primary">Sign In</button>
