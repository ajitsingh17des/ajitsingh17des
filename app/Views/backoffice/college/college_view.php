					...
					<div class="m-portlet__head-tools">
						<ul class="m-portlet__nav">
							<li class="m-portlet__nav-item">
								...
								<a href="<?php echo base_url('backoffice/school/add') ?>" class="btn m-btn--pill btn-outline-success m-btn m-btn--custom m-btn--icon ">
									...
									<center>
											<div class="m-btn-group m-btn-group--pill btn-group" role="group" aria-label="First group">
												<?php //if($permission_data['edit'] == 1){?>
													<a href="<?php echo base_url('backoffice/school/edit/'.($value['id']))?>">
												...
												<?php //if($permission_data['delete'] == 1){?>
													<a onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo base_url('backoffice/school/delete/'.($value['id'])) ?>">
												...
												<?php //if($permission_data['edit'] == 1){?>
													...
													<a onclick="return confirm('Do you sure want to deactive this record.');" href="<?php echo base_url(); ?>backoffice/school/deactive/<?php echo ($value['id']); ?>" title="Deactive" > 
													...
													<a>	
													<?php } else { ?>
													<a onclick="return confirm('Do you sure want to active this record.');" href="<?php echo base_url(); ?>backoffice/school/active/<?php echo ($value['id']); ?>" title="Active" >
