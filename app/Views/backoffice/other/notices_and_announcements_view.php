					...
					<div class="m-portlet__head-tools">
						<ul class="m-portlet__nav">
							<li class="m-portlet__nav-item">
								...
								<a href="<?php echo base_url('backoffice/notices_and_announcements/add') ?>" class="btn m-btn--pill btn-outline-success m-btn m-btn--custom m-btn--icon ">
									...
									<td style="width: 200px;">
										<center>
											<div class="m-btn-group m-btn-group--pill btn-group" role="group" aria-label="First group">
												<a href="<?php echo base_url('backoffice/notices_and_announcements/edit/'.$data['id']) ?>">
													<span class="btn m-btn--square  m-btn m-btn--gradient-from-info m-btn--gradient-to-accent"><i class="fa fa-pencil-alt"></i></span>
												</a>
												<a onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo base_url('backoffice/notices_and_announcements/delete/'.$data['id']) ?>">
												...
												<a onclick="return confirm('Do you sure want to deactive this record.');" href="<?php echo base_url(); ?>backoffice/notices_and_announcements/deactive/<?php echo $data['id']; ?>" title="Deactive" > 
												...
												<a>	
												<?php } else { ?>
												<a onclick="return confirm('Do you sure want to active this record.');" href="<?php echo base_url(); ?>backoffice/notices_and_announcements/active/<?php echo $data['id']; ?>" title="Active" >
