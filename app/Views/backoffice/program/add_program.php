							...
							<div class="m-portlet__head">							
								<div class="m-portlet__head-caption">								
									<div class="m-portlet__head-title">									
										...
										<h3 class="m-portlet__head-text">Add Program</h3>
								...
								<div class="m-portlet__head-caption">								
									<div class="m-portlet__head-title">									
										...
										<a href="<?php echo base_url('backoffice/program') ?>"><button type="button" class="btn m-btn--pill    btn-outline-primary"><span><i class="fa 	fa-angle-double-left "></i><span>	Back</span></span></button></a>											
									</div>							
								</div>									
							</div>	
							...
							<form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator" method="post" action="<?php echo ($act) ? $act : '' ?>" enctype="multipart/form-data" name="add_campus" id="add_campus">	
								...
								<div class="form-group m-form__group row">
								 ...
								 <div class="form-group m-form__group row">
										...
										<div class="col-lg-8 col-md-9 col-sm-12">
											<input type="text" placeholder="Enter ..." class="form-control" name="display_order" id="display_order" value="<?php if($editData){ echo  $editData['display_order'];}else{ echo  $maxdata['display_order']+1; } ?>">
										</div>
								</div>	
								...
								<div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">								
									<div class="m-form__actions m-form__actions--solid">									
											<div class="row">										
												...
												<a href="<?php echo base_url('backoffice/program') ?>"><button type="button" class="btn btn-outline-danger m-btn--pill"><span><i class="fa fa-times "></i><span>	Cancel</span></span></button></a>										
